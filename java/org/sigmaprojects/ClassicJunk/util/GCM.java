...
public class GCM {
    ...
    */
    ...
    private void sendRegistrationIdToBackend(String foundregid) {
        ...
        try {
            URL registerDeviceURL = new URL("http://api.classicjunk.sigmaprojects.org/device/register/?device_id="+CJApp.getDeviceUuid()+"&registration_id="+foundregid);
